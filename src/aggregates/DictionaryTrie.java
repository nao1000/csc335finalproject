...
public class DictionaryTrie {
	/**
	 * This class creates a typical Trie data structure (parse tree) that is used to
	 * efficiently validate words made by a player in Scrabble.
	 */

	private class TrieNode {
		/**
		 * This trie itself is a complex tree of TrieNodes that store will hold a
		 * character and an array of all of it's children. A word is found if one of
		 * those children has their terminal flag set to true
		 */
		private char c;
		...
		public void addChild(char nextC) {
			/**
			 * This method stores a new Node as child to this node. Using ASCII to help
			 * index, we an easy way to store and look up Nodes.
			 * 
		...
		public TrieNode getChild(char nextC) {
			/**
			 * This method gets the child that would be the letter given. Used with the
			 * childExist() method.
			 * 
		...
		public boolean childExist(char nextC) {
			/**
			 * This method ensures the child exists by making sure and instance of the Node
			 * is at the index location.
			 * 
	...
	private void initializeDictionary() {
		/**
		 * This method initializes the Trie with the Scrabble dictionary.
		 */
	...
	private void placeWord(String s) {
		/**
		 * This method iterates through a string and puts the word into the Trie/parse
		 * tree character by character.
		 * 
		 * It is set to private because in the context of the game, we will not be
		 * adding words to the dictionary. The words are given from a text file and
		 * there is no need to add words mid game
		 * 
	...
	public boolean isWord(String s) {
		/**
		 * This method validates a String by seeing if it exists in the Trie and is
		 * marked as a word
		 * 
